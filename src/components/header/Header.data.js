...
export const headerContent = [
  ...
  { headerImg: characters, headerText: "Characters" },
  { headerImg: inventory, headerText: "Inventory" },
  { headerImg: archive, headerText: "Archive" },
  { headerImg: calculator, headerText: "Calculator" },
];
